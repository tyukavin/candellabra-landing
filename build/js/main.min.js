...
document.addEventListener("DOMContentLoaded",()=>{console.log("load"),new WOW({boxClass:"wow",animateClass:"animate__animated",offset:0,mobile:!1}).init();const e=document.querySelector(".safe-content"),n=(new Parallax(e),document.querySelector(".support-content"));new Parallax(n)});
