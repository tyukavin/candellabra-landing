...
new WOW({boxClass:"wow",animateClass:"animate__animated",offset:0,mobile:!1}).init(),document.addEventListener("DOMContentLoaded",()=>{const e=new ScrollMagic.Controller;new ScrollMagic.Scene({triggerElement:".provider-slider"}).setClassToggle(".provider-slider","active").addTo(e),new ScrollMagic.Scene({triggerElement:".leave-brand-slider"}).setClassToggle(".leave-brand-slider","active").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-1","anim-1").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-2","anim-2").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-3","anim-3").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-4","anim-4").addTo(e);const t=document.querySelector(".safe-content"),l=(new Parallax(t),document.querySelector(".support-content")),n=(new Parallax(l),new HystModal({linkAttributeName:"data-hystmodal"}),document.querySelector(".js-btn-more")),a=document.querySelector(".js-row-visible"),o=document.querySelectorAll(".js-store-add");n.addEventListener("click",(function(){this.setAttribute("disabled","disabled"),a.classList.toggle("store-content__row--hidden"),o.forEach(e=>{e.className="animate__animated animate__zoomIn wow"})}));const s=document.querySelector(".js-btn-more-about"),r=document.querySelectorAll(".js-row-visible-about");s.addEventListener("click",(function(){this.setAttribute("disabled","disabled"),r.forEach(e=>{e.classList.toggle("about-content__row--hidden")})}))});
