...
new WOW({boxClass:"wow",animateClass:"animate__animated",offset:0,mobile:!1}).init(),document.addEventListener("DOMContentLoaded",()=>{const e=new ScrollMagic.Controller;new ScrollMagic.Scene({triggerElement:".provider-slider"}).setClassToggle(".provider-slider","active").addTo(e),new ScrollMagic.Scene({triggerElement:".leave-brand-slider"}).setClassToggle(".leave-brand-slider","active").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-1","anim-1").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-2","anim-2").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-3","anim-3").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-4","anim-4").addTo(e);const t=document.querySelector(".safe-content"),a=(new Parallax(t),document.querySelector(".support-content")),l=(new Parallax(a),new HystModal({linkAttributeName:"data-hystmodal"}),document.querySelector(".js-btn-more")),n=document.querySelector(".js-row-visible"),o=document.querySelectorAll(".js-store-add");l.addEventListener("click",(function(){this.setAttribute("disabled","disabled"),n.classList.toggle("store-content__row--hidden"),o.forEach(e=>{e.className="animate__animated animate__zoomIn wow"})}))});
