...
new WOW({boxClass:"wow",animateClass:"animate__animated",offset:0,mobile:!1}).init(),document.addEventListener("DOMContentLoaded",()=>{const e=new ScrollMagic.Controller;new ScrollMagic.Scene({triggerElement:".provider-slider"}).setClassToggle(".provider-slider","active").addTo(e),new ScrollMagic.Scene({triggerElement:".leave-brand-slider"}).setClassToggle(".leave-brand-slider","active").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-1","anim-1").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-2","anim-2").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-3","anim-3").addTo(e),new ScrollMagic.Scene({triggerElement:".platform-lines"}).setClassToggle(".js-anim-4","anim-4").addTo(e),new HystModal({linkAttributeName:"data-hystmodal"});const t=document.querySelector(".js-btn-more"),l=document.querySelector(".js-row-visible"),a=document.querySelectorAll(".js-store-add");t.addEventListener("click",(function(){this.setAttribute("disabled","disabled"),l.classList.toggle("store-content__row--hidden"),a.forEach(e=>{e.className="animate__animated animate__zoomIn wow"})}));const n=document.querySelector(".js-btn-more-about"),o=document.querySelectorAll(".js-row-visible-about");n.addEventListener("click",(function(){this.setAttribute("disabled","disabled"),o.forEach(e=>{e.classList.toggle("about-content__row--hidden")})}))});
