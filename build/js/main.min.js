...
new WOW({boxClass:"wow",animateClass:"animate__animated",offset:0,mobile:!1}).init(),document.addEventListener("DOMContentLoaded",()=>{const e=new ScrollMagic.Controller;new ScrollMagic.Scene({triggerElement:".provider-slider"}).setClassToggle(".provider-slider","active").addTo(e),new ScrollMagic.Scene({triggerElement:".leave-brand-slider"}).setClassToggle(".leave-brand-slider","active").addTo(e),new HystModal({linkAttributeName:"data-hystmodal"});const t=document.querySelector(".js-btn-more"),o=document.querySelector(".js-row-visible"),a=document.querySelectorAll(".js-store-add");t.addEventListener("click",(function(){this.setAttribute("disabled","disabled"),o.classList.toggle("store-content__row--hidden"),a.forEach(e=>{e.className="animate__animated animate__zoomIn wow"})}));const n=document.querySelector(".js-btn-more-about"),l=document.querySelectorAll(".js-row-visible-about");n.addEventListener("click",(function(){this.setAttribute("disabled","disabled"),l.forEach(e=>{e.classList.toggle("about-content__row--hidden")})}))});
